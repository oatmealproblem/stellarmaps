...
export const zMapSettings: z.Schema<MapSettings, z.ZodTypeDef, unknown> = z.object({
	...
	countryNamesSecondaryRelativeSize: z.number().nullable().catch(0.75),
	...
	starScapeStarsCount: z.number().nullable().catch(5000),
	...
	systemMapStarScale: z.number().nullable().catch(2),
	systemMapPlanetScale: z.number().nullable().catch(1),
	systemMapMoonScale: z.number().nullable().catch(0.5),
